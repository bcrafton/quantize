...
conv_block(256,  512, 1, noise=args.noise, weights=weights),
conv_block(512,  512, 2, noise=args.noise, weights=weights),

conv_block(512,  1024, 1, noise=args.noise, weights=weights),
conv_block(1024, 1024, 1, noise=args.noise, weights=weights),

avg_pool(4, 4, weights=weights),
dense_block(1024, 1000, noise=args.noise, weights=weights)
])
'''
m = model(layers=[
conv_block(3,    64, 1, noise=args.noise, weights=weights[0]),
conv_block(64,   64, 2, noise=args.noise, weights=weights[1]),
conv_block(64,   128, 2, noise=args.noise, weights=weights[2]),
conv_block(128,  256, 2, noise=args.noise, weights=weights[3]),
conv_block(256,  512, 2, noise=args.noise, weights=weights[4]),
conv_block(512,  1024, 1, noise=args.noise, weights=weights[5]),
