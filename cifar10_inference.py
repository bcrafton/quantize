...
m = model(layers=[
conv_block((3,3,3,64), 2, noise=args.noise, weights=weights),
conv_block((3,3,64,64), 1, noise=args.noise, weights=weights),

conv_block((3,3,64,128), 2, noise=args.noise, weights=weights),
conv_block((3,3,128,128), 1, noise=args.noise, weights=weights),

conv_block((3,3,128,256), 2, noise=args.noise, weights=weights),
conv_block((3,3,256,256), 1, noise=args.noise, weights=weights),
