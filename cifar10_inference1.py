...
m = model(layers=[
conv_block(3,   32, 1, noise=args.noise, weights=weights[0]),
conv_block(32,  32, 2, noise=args.noise, weights=weights[1]),

conv_block(32,  64, 1, noise=args.noise, weights=weights[2]),
conv_block(64,  64, 2, noise=args.noise, weights=weights[3]),

conv_block(64,  128, 1, noise=args.noise, weights=weights[4]),
conv_block(128, 128, 2, noise=args.noise, weights=weights[5]),

avg_pool(4, 4, weights=weights[6]),
dense_block(128, 10, noise=args.noise, weights=weights[7])
])
